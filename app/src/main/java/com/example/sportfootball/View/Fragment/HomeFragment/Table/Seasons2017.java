 ...
 */
public class Seasons2017 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvTableFootball = view.findViewById (R.id.rv_table_football2017);
        ...
        footballViewModel.setTableSeasons();
        footballViewModel.getTableSeasons().observe(this, getTablesFootball);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_seasons2017, container, false);
    }
}
